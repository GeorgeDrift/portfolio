...
// A generic icon component for skills, you can replace these with more specific SVGs
...
export const CloudIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 004.5 4.5H18a3.75 3.75 0 001.332-7.257 3 3 0 00-2.087-5.022c.209-.286.422-.573.655-.851a.75.75 0 10-1.22-.872A4.5 4.5 0 0018 4.5H6.75a4.5 4.5 0 00-4.5 4.5v.75z" />
  </svg>
);
...
export const HardwareIcon = (props: React.SVGProps<SVGSVGElement>) => (
 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const ProgrammingIcon = (props: React.SVGProps<SVGSVGElement>) => (
 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
const iconMap: { [key: string]: React.FC<React.SVGProps<SVGSVGElement>> } = {
  ...
  'mobile development': MobileIcon,
};

export const getSkillIcon = (iconName: string): React.ReactNode => {
  const IconComponent = iconMap[iconName.toLowerCase()] || CodeIcon; // Default to CodeIcon
